...
gem "jbuilder"
gem 'faraday'    # Cliente HTTP para realizar requisições à API do GROQ
gem 'sidekiq'    # Para processamento de jobs em segundo plano
gem 'redis'      # Necessário para o Sidekiq
